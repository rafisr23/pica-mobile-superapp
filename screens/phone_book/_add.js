        ...
        <View style={{ backgroundColor: "f2f2f2", width: "100%", height: "100%" }}>
          <View style={{ flex: 1, alignItems: "center", marginTop: 20, backgroundColor: "white", margin: 20, borderRadius: 10 }}>
            ...
            <View style={styles.inputContainer}>
              <TextInput onChangeText={(text) => setName(text)} placeholder="Input Name" style={styles.input} value={name} />
              <TextInput onChangeText={(text) => setNumber(text)} placeholder="Input Number" style={styles.input} value={number} />
            </View>
